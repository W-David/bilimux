  ...
  <div class="flex items-center gap-2 bg-white/4 px-2 py-1 rounded-full">
    <DeleteTaskDialog
      ...
      <button
        ...
        <Trash2Icon
          class="size-4 text-red-400 transition-all duration-200 group-hover:scale-110 group-hover:text-red-300 group-disabled:scale-100" />
      </button>
    </DeleteTaskDialog>
    <button
      type="button"
      ...
      @click="emit('reveal')">
      <FolderOpenIcon
        class="size-4 text-gray-300 transition-all duration-200 group-hover:scale-110 group-hover:text-white group-disabled:scale-100" />
    </button>
    <button
      type="button"
      aria-label="文件详情"
      ...
      @click="emit('details')">
      <InfoIcon class="size-4 text-gray-300 transition-all duration-200 group-hover:scale-110 group-hover:text-white" />
    </button>
    <button
      v-if="canPlay"
      type="button"
