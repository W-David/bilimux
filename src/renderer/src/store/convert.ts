...
export const useConvertStore = defineStore('convert', () => {
  ...
  if (import.meta.env.DEV) {
    ...
    const seedLiveTasks = [
      ...
      {
        id: 'seed-live-importing',
        bvid: 'BV1SEEDIMP01',
        title: '【测试】导入中',
        fileName: 'seed-importing.mp4',
        filePath: '',
        status: 'importing',
        progress: 12,
        finished: false,
      ...
      {
        id: 'seed-live-writing',
        bvid: 'BV1SEEDWRT01',
        title: '【测试】写入中',
        fileName: 'seed-writing.mp4',
        filePath: '',
        status: 'writing',
        progress: 67,
        finished: false,
      ...
      {
        id: 'seed-live-preprocess',
        bvid: 'BV1SEEDPRE01',
        title: '【测试】预处理',
        fileName: 'seed-preprocess.mp4',
        filePath: '',
        status: 'preprocess',
        progress: 88,
        finished: false,
      ...
      {
        id: 'seed-live-success',
        bvid: 'BV1SEEDSUC01',
        title: '【测试】已完成',
        fileName: 'seed-success.mp4',
        filePath: '',
        status: 'success',
        progress: 100,
        finished: true,
      ...
      },
      {
        ...
        bvid: 'BV1SEEDFAI01',
        title: '【测试】出错了',
        fileName: 'seed-fail.mp4',
        filePath: '',
        status: 'fail',
        progress: 0,
        finished: true,
        message: '合成失败: MP4Box 退出码 1，无法合成视频流'
      },
      {
        id: 'seed-live-skipped',
        bvid: 'BV1SEEDSKP01',
        title: '【测试】已跳过',
        fileName: 'seed-skipped.mp4',
        filePath: '',
        status: 'skipped',
        progress: 100,
        finished: true,
      ...
      {
        id: 'seed-live-missing',
        bvid: 'BV1SEEDMIS01',
        title: '【测试】文件丢失',
        fileName: 'seed-missing.mp4',
        filePath: '',
        status: 'missing',
        progress: 0,
        finished: true,
